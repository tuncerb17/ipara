...
class iParaPayment
{
    ...
    public function payThreeD()
    {
        ...
        print("<input type=\"hidden\" name=\"cardOwnerName\" value=\"" . urlencode($this->card['owner_name']) . "\"/>");
        ...
        print("<input type=\"hidden\" name=\"purchaserName\" value=\"" . urlencode($this->purchaser['name']) . "\"/>");
        print("<input type=\"hidden\" name=\"purchaserSurname\" value=\"" . urlencode($this->purchaser['surname']) . "\"/>");
